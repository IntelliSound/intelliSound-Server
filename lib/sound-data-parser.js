...
//Andrew - The bufferMapper function is going to accept a parsed wave-file and output an array of values corresponding to the data subchunk in a format which can be accepted as input to the neural network.
...
module.exports = data => {
  ...
  if (parsedWaveFile.bitsPerSample !== 16) {
    throw new TypeError(`file's bit depth must 16`);
  }
